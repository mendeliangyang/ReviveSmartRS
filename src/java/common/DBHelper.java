...
//        return DBHelper.ASAConnect(setModel.dbUser, setModel.dbPwd, setModel.dbAddress, setModel.dbName, setModel.dbPort);
    ...
    public static String SqlSelectFactory(ReviveRSParamModel paramModel) throws Exception {
        ...
        try {
            ...
            if (paramModel.db_leftLink != null) {
                for (int i = 0; i < paramModel.db_leftLink.size(); i++) {
                    ...
                    for (int j = 0; j < db_leftLink.dbll_linkSeekCol.size(); j++) {
                        sqlsb.append(" l").append(i).append(".").append(db_leftLink.dbll_linkSeekCol.get(j)).append(" as ").append(db_leftLink.dbll_tableName).append("_").append(db_leftLink.dbll_linkSeekCol.get(j)).append(" ,");
                    }
